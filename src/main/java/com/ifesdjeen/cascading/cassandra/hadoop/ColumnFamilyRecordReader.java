/*
 * This code was a part of Cassandra, got copied here because of the bug that's occuring with
 * newer versions of hadoop, especially applicable to Cascading/Cascalog integration.
 *
 * Of course it's licensed to the Cassandra guys, and I'm not going to pretend I wrote it.
 */
...
public class ColumnFamilyRecordReader extends RecordReader<ByteBuffer, SortedMap<ByteBuffer, IColumn>>
  ...
  private abstract class RowIterator extends AbstractIterator<Pair<ByteBuffer, SortedMap<ByteBuffer, IColumn>>> {
    ...
    protected ByteBuffer lastRowKey = ByteBufferUtil.EMPTY_BYTE_BUFFER;
  ...
  private class WideRowIterator extends RowIterator {
    ...
    // private ByteBuffer lastRowKey = ByteBufferUtil.EMPTY_BYTE_BUFFER;
